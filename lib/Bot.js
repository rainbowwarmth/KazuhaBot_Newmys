...
async function init() {
    kazuha_1.default._logger.mark(`-------(≡^∇^≡)-------`);
    kazuha_1.default._logger.mark(kazuha_1.default.chalk.cyan(kazuha_1.default.Bot.name + ' v' + kazuha_1.default.Bot.version + '启动中...'));
    kazuha_1.default._logger.mark(kazuha_1.default.chalk.greenBright('https://github.com/rainbowwarmth/KazuhaBot_Newmys.git'));
